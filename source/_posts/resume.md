...
> 云听融媒——全国领先的融媒业务平台, 提供云采编、云制播、直播微信互动、电台APP建设、微信小程序建设等融媒生产和运营服务，以及听众数据、播后影响力分析、数据大屏展示等数据分析解决方案。
...
> 超过10+的子系统，只有3位前端开发人员，导致我们需要同时开发2-3个子系统，常常每个子系统的工期都很短且完成日期相互冲突。
>
> - 根据优先级，更加细粒度排期，合理安排加班时间，组织会议优先内部消化。
> - 内部无法消化上报异常，组织会议寻求其他项目组前端帮助。
> - 寻求外援失败，组织会议请求产品经理需求调整或降级。
>
> 由于历史原因和系统的技术架构不同（.net、php、java）,一些老系统的前端代码是由后台开发人员写的（不规范，冗余代码繁多，实现方式不合理等），加上不断的更新迭代导致现在系统耦合度极高难以维护和扩展。
>
...
> 得到了项目组同事的一度认可，好几次拿到了月度星级员工前三以及项目业绩加成，并且年终被评为优秀员工。

技术栈：

> jquery、vue全家桶、element-ui、axios、vue-cli，多页+单页前后端分离模式，多页+单页前后端不分离模式。
...
>基于apicloud平台开发的一款汽车服务类app，主要服务对象是凯利车管家的线下门店客户。
...
> app上线后稳定运行，得到了客户的一致好评，得到了领导的赞赏给予加薪奖励。

技术栈：

> jquery、layui、apicloud、vue、requierjs
...
#### 电子商务公共服务平台（pc&mobile）(已下线)

项目描述：

> 电子商务公共服务平台是中智汇集团的主要产品，是给政府用的网站。主要模块有：行业 动态、产业政策、电商学院、人才基地、服务市场、活动沙龙、产业基地、电商政务等。
...
> 作为实习生第一次接触实际项目，导师要求实现一个轮播插件。
>
> - 明确导师的需求，网上查看别人实现的源代码，借鉴他们的思路举一反三，最终完成了轮播插件。

收获：

> 学会插件的编写，随着后面的不断进步，完善了轮播插件，新开发了表单插件，并在公司的多个项目中应用且稳定运行，深受导师和同事们的认可，毕业后成功转正。
...
> 项目按时高质的完成了，学习了工程化开发模式，得到了领导和同事的一致认可，并在年终被评为A级优秀员工。

技术栈：

> html、css、js、jquery、gulp、requirejs
...
- 熟练使用sass css预处理器，熟悉gulp、webpack等自动化构建工具的使用。
- 具有丰富的前后端分离、未分离项目搭建和开发经验。
- 熟练使用SVN , Git等版本管理工具。
- 熟练使用apicloud进行app开发，熟悉Nginx的搭建，了解java、node、react。
